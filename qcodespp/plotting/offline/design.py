...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_3.addWidget(self.refresh_label)
        self.refresh_line_edit = QtWidgets.QLineEdit(self.central_widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.refresh_line_edit.sizePolicy().hasHeightForWidth())
        self.refresh_line_edit.setSizePolicy(sizePolicy)
        self.refresh_line_edit.setMinimumSize(QtCore.QSize(40, 0))
        self.refresh_line_edit.setMaximumSize(QtCore.QSize(50, 16777215))
        self.refresh_line_edit.setInputMethodHints(QtCore.Qt.ImhNone)
        self.refresh_line_edit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.refresh_line_edit.setObjectName("refresh_line_edit")
        self.horizontalLayout_3.addWidget(self.refresh_line_edit)
        self.refreshunit_label = QtWidgets.QLabel(self.central_widget)
        self.refreshunit_label.setObjectName("refreshunit_label")
        self.horizontalLayout_3.addWidget(self.refreshunit_label)
