...
class GS200(VisaInstrument):
    ...
    def _set_output(self, output_level: float) -> None:
        ...
        if self._cached_range_value is None or abs(output_level) > abs(self_range*1.2):
            ...
            if abs(output_level) > abs(self_range*1.2):
