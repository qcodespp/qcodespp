...
class Keithley6500(VisaInstrument):
    ...
    def __init__(
        ...
        **kwargs: "Unpack[VisaInstrumentKWArgs]",
        ...
        """
        Stripped down driver for the Keithley 6500 multimeter. 

        Driver containing the most basic functions and commonly used commands.
        The qcodes_contrib_drivers version makes some unfortunate choices in 
        that capturing the snapshot changes the measurement mode. This driver 
        avoids that issue.
